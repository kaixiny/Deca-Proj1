...
│  2021–今     继续飞速迭代，当前版本已达 22.9.x
```

**来源**：
- Kabam→Gaea 交易：**[HIGH]** [[Business Wire 公告 2016-01-07]](https://www.businesswire.com/news/home/20160107006328/en/Kabam-Divests-Classic-Mobile-Games-and-Publishing-Business-to-GAEA)
...
▼
盖娅互娱 / 飓风工作室
│  2017-06-30 《霍比特人》IP 授权到期，游戏关闭
│  2017        【关键策略节点】去 IP 化重塑：将游戏核心玩法 1:1 迁移至
│             自有 IP《Elves vs Dwarves》；玩家账号、进度全量迁移
▼
...
**来源**：
- 霍比特人游戏 2017 年关闭、EVD 为替代品：**[MEDIUM]** [[Search results; Weezeewig 社区站]](https://hobbit.weezeewig.com/doku/doku.php/start)
- Google Play 包名 `com.kabam.evd`（原 Kabam 包名保留）：**[HIGH]** [[Google Play 商店]](https://play.google.com/store/apps/details?id=com.kabam.evd)
...
公司于 2020 年被 Embracer Group 以约 €25M + 最高 €60M 对赌款收购，验证了这一模式的规模化可行性。 **[HIGH]** [[Embracer 收购 Deca 公告]](https://embracer.com/releases/embracer-group-acquires-deca-games/)

2022 财年 Deca 整体收入达 **€156.05M**，利润率超 35%。 **[HIGH]** [[Wikipedia: Deca Games]](https://en.wikipedia.org/wiki/Deca_Games)
...
这一操作将游戏从**IP 授权依赖型**转型为**独立 IP**，消除了未来再次面临授权到期的风险，为长期运营奠定基础。 **[MEDIUM]** [来源：社区站 hobbit.weezeewig.com + 搜索结果综合]

### 阶段二：Deca 接管后的内容深化（2021–2024）

Deca 接手后延续了飓风工作室原有团队和运营节奏，重点投入**系统深度扩展**：

| 时间（近似） | 版本 | 策略动作 | 来源 |
|------------|------|----------|------|
| 2024-09 | v16.8.9 | 新城堡皮肤；活动 bug 修复 | **[HIGH]** [Apple App Store](https://apps.apple.com/us/app/elves-vs-dwarves/id1231491435) |
| 2024-11 | v16.9.0 | 转盘优化（加入保底与连抽机制）— 重大变现机制调整 | **[HIGH]** [Apple App Store] |
| 2024-12 | v16.9.1 | 英雄解锁上限扩展至 6-10 星 — 纵向进深延伸 | **[HIGH]** [Apple App Store] |
| 2025-02 | v16.9.3 | 添加聊天翻译功能；英雄 6 级装备 — 社群互联与装备深化 | **[HIGH]** [Apple App Store] |
...
游戏持续活跃更新（每月至少一次），但**App Store 评分仅 2.2/5（465 评价）** **[HIGH]** [Apple App Store]，表明玩家满意度存在显著挑战。玩家反馈提及变现压力增大。
...
Gaea 接手后以全球化运营为主，不大改核心玩法，专注于稳定的活动运营和功能维护。收购时（2021-Q3）合并八款游戏共约 150,000 DAU / 800,000 MAU，季度总毛收入约 SEK 5,000万。 **[HIGH]** [[Embracer 新闻稿]](https://embracer.com/releases/embracer-group-acquires-mobile-game-developer-jufeng-studio-and-eight-mobile-titles/)

### 阶段三：Deca 接管后的系统扩展（2021–2026）

当前版本已达 22.x，说明游戏进行了超过 22 个大版本迭代。
...
2. **周年纪念锚点**：14 周年纪念皮肤（2026 年游戏发布已 14 年）以周年节点作为玩家情感锚点，强化归属感。
...
App Store 评分 **3.1/5（413 评价）** **[HIGH]** [Apple App Store]，高于 EVD 但仍属中低水平。社区博主（2024 年 12 月）评论游戏"losing gas day by day"。 **[LOW]** [[kocbattle4thenorth.home.blog]](https://kocbattle4thenorth.home.blog/the-round-table/)
...
| **变现机制演化** | 转盘保底（2024）→ Battle Pass（2026 年 3 月） | 推荐礼包（2025）→ 特殊卡牌（2025）→ 城市光环（2026） |
| **社群工具** | 聊天翻译（2025）提升国际化 | Discord 官方社群 + 周年纪念活动 |
| **服务器管理** | 通用 Deca 服务器合并政策 | 通用 Deca 服务器合并政策 |
| **App Store 评分** | 2.2/5（较低）| 3.1/5（中低）|
| **当前版本号** | 17.0.7 | 22.9.0（版本数量显著更高，游戏历史更长）|
...
2023 年 6 月，因一笔 20 亿美元战略投资意外终止，Embracer Group 宣布大规模重组，关闭 44 个工作室、裁员 4,532 人（至 2024 年 5 月）。 **[HIGH]** [[Embracer 官方声明]](https://embracer.com/releases/embracer-group-announces-comprehensive-restructuring-program-with-immediate-implementation/)
...
| 八款游戏季度毛收入 | ~SEK 5,000万 | 2021-Q3 | Embracer 官方新闻稿 | HIGH |
| Deca 年营收 | €156.05M | 2022 财年 | Wikipedia | HIGH |
| Deca 利润率 | >35% | 收购时预测 | Embracer 收购公告 | HIGH |
...
| KBN 历史注册玩家 | 950万+ | 未注明 | App Store 描述（营销文案） | LOW |
...
| 置信度 | 声明数量 | 说明 |
|--------|----------|------|
| HIGH | 28 条 | 两个以上独立一手来源，或直接可验证数据（App Store / 官方新闻稿） |
| MEDIUM | 7 条 | 单一权威来源，或多来源综合推断 |
| LOW | 3 条 | 仅社区来源或营销文案 |
...
2. **无单款游戏财务数据**：Embracer 未拆分 EVD / KBN 各自的收入或 DAU 数据，仅有合并的八款游戏聚合数据。
3. **EVD 2017 年重品牌节点**：飓风工作室关于霍比特人 IP 授权到期及 EVD 创建的决策细节，仅通过社区站和搜索摘要获得，缺乏官方一手文件。
4. **红队审查潜在误差**：同工具同偏差风险；URL 腐烂可能导致部分声明验证结果不准确。

---

*报告由 Claude Code + company-game-research skill 生成，研究时间 2026-05-17。*
