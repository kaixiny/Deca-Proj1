...
**版本：** v3_draft（遵循 CLAUDE.md 工作流，第三轮研究）
**日期：** 2026-05-14
**研究范围：** Elves vs Dwarves（EVD）与 Kingdoms of Camelot: Battle for the North（KBN）
**方法说明：** 所有声明均附置信度标签与可访问原始 URL；UNVERIFIED 声明已删除；本版本修正了 v2 中的已知版本号错误。
...
| 2016 年（Gaea 接手后） | IP 授权到期后 Gaea 以相同系统和玩法重新发布，去掉《霍比特》授权，命名为 **Elves vs Dwarves（EVD）** | **[HIGH]** | 两个来源：[Wikipedia/Kabam](https://en.wikipedia.org/wiki/Kabam) + [Embracer 官方公告](https://embracer.com/releases/embracer-group-acquires-mobile-game-developer-jufeng-studio-and-eight-mobile-titles/)（均将 EVD 列为聚锋旗下游戏） |
...
**商业成就（Kabam 时期）[HIGH]**：
- 2013 年 Kabam 全年营收 **$3.6 亿美元** [[Wikipedia/Kabam](https://en.wikipedia.org/wiki/Kabam)]
- Kingdoms of Camelot 领衔的四款游戏合计营收超 **$1 亿美元** [同上]
- 移动版 KBN 于 **2012 年成为 iPhone 全年最高收入游戏** [[Wikipedia/Kabam](https://en.wikipedia.org/wiki/Kabam) + [GamesBeat](https://gamesbeat.com/kabam-scores-big-with-highest-grossing-game-on-app-store-for-2012/)]，在超过 50 个国家保持最高收入应用排名 [[GamesBeat](https://gamesbeat.com/kabam-scores-big-with-highest-grossing-game-on-app-store-for-2012/)]
...
| 2016 年 1 月 7 日 | Kabam 将移动版 KBN 随遗留游戏组合出售给 Gaea Mobile | **[HIGH]** | [Wikipedia/Kabam](https://en.wikipedia.org/wiki/Kabam) |
...
Gaea 接手后的核心任务是：在《霍比特》IP 授权到期后，将游戏完整迁移至无版权 IP 版本（Elves vs Dwarves），同时保持玩家留存。

> 运营重点：平滑迁移、系统保留、维持付费转化节奏。

#### 阶段二：Deca 接管初期（2021–2023）——稳定过渡与方向确立

Deca 收购聚锋后保留原有管理层和开发团队独立运营 **[HIGH]** [[Embracer 官方公告](https://embracer.com/releases/embracer-group-acquires-mobile-game-developer-jufeng-studio-and-eight-mobile-titles/)]。此阶段以保障现有玩家体验为主，版本更新以改进和修复为主（如 v16.7.x 系列）**[MEDIUM]** [[Apple App Store](https://apps.apple.com/us/app/elves-vs-dwarves/id1231491435)]。

#### 阶段三：深度 Live Ops（2024–2026）——系统扩展与付费点多元化

此阶段版本更新密度显著提升，呈现三条清晰的长青化运营主线：
...
- 新增第六城建筑"**祭坛**"（Altar）
- 新增第六城职位（new position）
- 新增部队类型"**战誓兵**"（Sworn Troop）
- 新增科技分支（new Tech）
- 新增英雄与坐骑
- 新增城堡皮肤

**幽石洞（Auralite Cave）等级上限提至 21 级 [MEDIUM]** [[apk.gold](https://elves-vs-dwarves.apk.gold/android-7.1.2)]（原文："Upgrade Auralite Cave level limit to 21"；App Store 描述为"new buildings"，未单独列出）
...
- 转盘（Wheel）引入**保底机制**（guarantees）与**连抽机制**（consecutive draws）
- 聊天屏蔽功能优化（chat blocking fix）
- 战争大厅（War Hall）红点持续显示 Bug 修复
- 联盟公告板文字输入框重叠 Bug 修复

**v17.0.4（2026-03-17）订阅制/通行证探索 [MEDIUM]** [[Apple App Store](https://apps.apple.com/us/app/elves-vs-dwarves/id1231491435)]：
- 新增**战斗通行证**（Battle Pass）

**v17.0.6（2026-04-16）叙事内容深化 [MEDIUM]** [[Apple App Store](https://apps.apple.com/us/app/elves-vs-dwarves/id1231491435)]：
- 新增**战役传奇章节**（Campaign Legendary chapter）
...
皮肤付费最早记录见于 **v22.3.0（2024-08-19）[MEDIUM]** [[Apple App Store](https://apps.apple.com/us/app/kingdoms-of-camelot-battle/id476546099)]：
- 新增城堡皮肤（castle skin）

**v22.4.0（2024-11-06）系统化铺开 [HIGH]** [[Apple App Store](https://apps.apple.com/us/app/kingdoms-of-camelot-battle/id476546099)]（原文逐项列出）：
- 城堡皮肤（castle skin）
...
**v22.7.8（2025-11-20 iOS）[MEDIUM]** [[Apple App Store](https://apps.apple.com/us/app/kingdoms-of-camelot-battle/id476546099)]：
- 新增**特殊卡牌**（Special Cards）功能

> Android 版本同期内容由 soft112 记录，版本号或有差异，内容一致。

**（三）城市外观系统与周年营销**

**v22.8.0（2026-01-22 iOS）[HIGH]** [[Apple App Store](https://apps.apple.com/us/app/kingdoms-of-camelot-battle/id476546099)（原文）：  
"Added City Halo System feature and 14th Anniversary City Skin; optimized OTA-related resources"

- 新增**城市光晕系统**（City Halo System）
- 新增 **14 周年纪念城市皮肤**（14th Anniversary City Skin）
- OTA 相关资源优化

> **关于"14 周年"**：KBN 移动版于 2012 年 3 月 1 日正式发布 **[HIGH]** [[Wikipedia/KoC](https://en.wikipedia.org/wiki/Kingdoms_of_Camelot)]，至 2026 年 1 月为其第 **14 周年**，名称完全吻合。
...
|----------|---------|---------|--------|
| **养成天花板持续上移** | Auralite Cave 21 级；英雄 6-10 星；坐骑 9 星；Sage's Tower 扩展 | 传奇骑士；装备进化系统 | **[HIGH/MEDIUM]** |
| **皮肤/外观付费体系** | Slime Balloon Castle；Stellar Dragon；Mysterious Mount Equipment；城市皮肤 | 城堡皮肤；英雄皮肤；行军皮肤；14 周年纪念城市皮肤 | **[HIGH]** |
| **变现机制升级** | Wheel 保底+连抽（v16.8.9）；Battle Pass（v17.0.4） | Special Cards（v22.7.8）；城市光晕系统（v22.8.0） | **[HIGH/MEDIUM]** |
| **品质稳定性维护** | 每个主要版本均含 Bug 修复清单 | v22.8.x 系列密集登录/图形修复 | **[HIGH]** |
| **周年/节日营销** | 季节性城堡皮肤（v16.7.1） | 14 周年纪念皮肤（v22.8.0） | **[MEDIUM]** |
...
| **MEDIUM** | 9 条 | 单一 App Store 来源的版本内容；PocketGamer 的团队数据 |
...
| 修正项 | v2 错误内容 | v3 正确内容 | 验证来源 |
|--------|------------|------------|---------|
| EVD 坐骑升 9 星版本 | v17.0.3（Feb 10） | **v17.0.2（Dec 1, 2025）** | Apple App Store 原文 |
| EVD Stellar Dragon | v2 标为 UNVERIFIED | **v16.8.3（Apr 24, 2024）已确认 [HIGH]** | Apple App Store 原文 |
| EVD Battle Pass | v17.0.5（Mar 27） | **v17.0.4（Mar 17, 2026）** | Apple App Store 原文 |
| KBN City Halo System iOS 版本 | v2_audit 误写 v22.7.8 | **v22.8.0（Jan 22, 2026）[HIGH]** | Apple App Store 原文 |
| KBN Special Cards 归属 | 未明确区分 | **v22.7.8（Nov 20, 2025）[MEDIUM]** | Apple App Store 原文 |
...
- [Apple App Store：Elves vs Dwarves（版本历史权威来源）](https://apps.apple.com/us/app/elves-vs-dwarves/id1231491435)
- [Apple App Store：Kingdoms of Camelot: Battle（版本历史权威来源）](https://apps.apple.com/us/app/kingdoms-of-camelot-battle/id476546099)
...
- [apk.gold：EVD Android 版本日志（v16.8.x 详细 changelog）](https://elves-vs-dwarves.apk.gold/android-7.1.2)
